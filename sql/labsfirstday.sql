...
SELECT
  ...
  , AVG(CASE WHEN labname = 'Hct' THEN labresult ELSE null END) as HEMATOCRIT_mean
  ...
  , AVG(CASE WHEN labname = 'Hgb' THEN labresult ELSE null END) as HEMOGLOBIN_mean
  ...
  , MIN(CASE WHEN labname = 'ALT (SGPT)' THEN labresult ELSE null end) as ALT_min
  , MAX(CASE WHEN labname = 'ALT (SGPT)' THEN labresult ELSE null end) as ALT_max
  , MIN(CASE WHEN labname = 'AST (SGOT)' THEN labresult ELSE null end) as AST_min
  , MAX(CASE WHEN labname = 'AST (SGOT)' THEN labresult ELSE null end) as AST_max
  , MIN(CASE WHEN labname = 'alkaline phos.' THEN labresult ELSE null end) as ALKPHOS_min
  , MAX(CASE WHEN labname = 'alkaline phos.' THEN labresult ELSE null end) as ALKPHOS_max
